...
public class TeacherTimes extends Activity {
    EditText userName;
    Button login_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if (list != null) {
                    ...
                    Call<List<TeacherTimeTable>> datacall = apiCall.getTeacherTime();
        ...
        final Call<List<TeacherTimeTable>> datacall = apiCall.getTeacherTime();

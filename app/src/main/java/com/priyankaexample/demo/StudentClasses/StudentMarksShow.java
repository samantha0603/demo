...
public class StudentMarksShow extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CoordinatorLayout mylayout;
            ...
            recyclerView =findViewById(R.id.homerv1);
            recyclerView.setHasFixedSize(true );
            recyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
            nocon=findViewById(R.id.nocon1);
            ...
            final SwipeRefreshLayout refreshLayout=findViewById(R.id.swipid1);

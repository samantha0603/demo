...
import com.priyankaexample.demo.TeacherClasses.DataAdapter;
import com.priyankaexample.demo.adapters.CourseAdapter;
...
public class StudentCourse extends Activity {
    RecyclerView recyclerView;
    ProgressBar progressBar ;
    List<CourseData> list1;
            ...
            refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                ...
                public void onRefresh() {
                    ...
                    if (list1 != null) {
                        ...
                        datacall = apiCall.getStudentCourse();
                        datacall.enqueue(new Callback<List<CourseData>>() {
                            @Override
                            public void onResponse(Call<List<CourseData>> call, Response<List<CourseData>> response) {
                                ...
                                recyclerView.setAdapter(new CourseAdapter(list1, R.layout.course_student_view, getApplicationContext()));
